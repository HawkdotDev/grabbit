...
import { SortField, ColumnKey, ColumnWidths, MIN_COLUMN_WIDTHS, VisibleColumns } from './types'

export type { SortField, ColumnKey, ColumnWidths, VisibleColumns }
...
export const TaskTableHeader: React.FC<TaskTableHeaderProps> = React.memo(
  ({ onSort, sortField, sortAsc, columnWidths, onResizeStart, visibleColumns }) => {
    const isColVisible = (key: ColumnKey): boolean => {
