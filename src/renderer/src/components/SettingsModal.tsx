...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4 select-none font-mono text-xs">
      <div className="bg-[#18191d] border border-[#2a2d34] rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden animate-in fade-in duration-200">
        {/* Header */}
        ...
        {/* Tab Navigation */}
        <div className="flex border-b border-[#2a2d34] bg-[#121316] px-4 pt-2">
          {[
        ...
        <form onSubmit={handleSave} className="p-6 space-y-4">
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="h-4 w-4 accent-[#a3e635] rounded"
                />
          ...
          {activeTab === 'remote' && (
            <div className="space-y-3 text-xs text-slate-400">
              ...
              <div className="p-3 bg-[#121316] rounded-xl border border-[#2a2d34] font-mono text-[11px] space-y-1">
